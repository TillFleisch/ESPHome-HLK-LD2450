...
namespace esphome::ld2450
{
    ...
    /**
     * User controlled number component which updates the max tilt angle on it's parent.
     */
    class MaxTiltAngleNumber : public number::Number, public Component, public Parented<LD2450>
    {
    public:
        void setup() override;
    ...
    protected:
         ...
         * @param value new maximum tilt angle value
         */
